        ...
        <div class="main-panel my_top_margin">
            <div class="content-wrapper">
                <div class="page-header">
                    <h3 class="page-title"> Assign Employees To Department </h3>
                </div>
                <div class="row">
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Assign Employees To Departments</h4>
                                <form class="forms-sample" wire:submit.prevent="submit">
                                    <div class="form-group">
                                        <label for="catalogue">Upload Employee Catalogue <i
                                                class="text-info">
                                                <a href="{{ asset('docs/assign_employees_departments.csv') }}">Check out
                                                    upload
                                                    template</a>
                                            </i></label>
                                        <input type="file"
