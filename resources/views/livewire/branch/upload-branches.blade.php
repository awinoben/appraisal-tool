        ...
        <div class="main-panel my_top_margin">
            <div class="content-wrapper">
                <div class="page-header">
                    <h3 class="page-title"> Upload Branch </h3>
                </div>
                <div class="row">
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Upload Branches</h4>
                                <form class="forms-sample" wire:submit.prevent="submit">
                                    <div class="form-group">
                                        <label for="catalogue">Upload Branch Catalogue <i
                                                class="text-info">
                                                <a href="{{ asset('docs/branches.csv') }}">Check out upload
                                                    template</a>
                                            </i></label>
                                        <input type="file"
